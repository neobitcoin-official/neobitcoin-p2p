...
function builder(options) {
  ...
  if (!options.network) {
    options.network = neobitcoin.Networks.defaultNetwork;
  }

  options.Block = options.Block || neobitcoin.Block;
  options.BlockHeader = options.BlockHeader || neobitcoin.BlockHeader;
  options.Transaction = options.Transaction || neobitcoin.Transaction;
  options.MerkleBlock = options.MerkleBlock || neobitcoin.MerkleBlock;
  options.MnListDiff = options.MnListDiff || neobitcoin.MnListDiff;
